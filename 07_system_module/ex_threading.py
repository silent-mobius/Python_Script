#!/usr/bin/env python3
# taken from https://www.simplifiedpython.net/python-threading-example/
# another link for example https://realpython.com/intro-to-python-threading/
''' # preview code for threading
import time
